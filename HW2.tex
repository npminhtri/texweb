...
\begin{proof}
    ...
    \[\begin{pmatrix}
        ...
        Below I provided how to compute the first few entries of the Grammian matrix of the Killing form - The computation is quite tedious, and it is essentially the same for every 
        other entries, just need to be patient. 
