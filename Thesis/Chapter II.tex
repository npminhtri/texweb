...
$r \in R$. We call it \textit{standard parabolic subgroup} of $W$. Set $P_J = BW_JB$ as in the notation of 
...
\end{itemize}
\end{theorem}
\end{definition}\todo{add proof/references?}
The above theorem leads to the following definitions of parabolic subgroup
