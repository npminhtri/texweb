...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item Assume that the lemma holds for $r >1$. Consider
              ...
              is finite to one, then we are done. But this is due to the observation of $\bigwedge^r M$ determines the lattice $L \cap (M \otimes \mathbb{Q})$ and the index of $M$ inside this lattice.\qedhere
    \end{itemize}
\end{proof}
\begin{definition}
