...
this is the lattice that achieve all the successive minima at the same time, see \cite{MR2153282}.
...
In this section, we introduce the idea of Grayson in defining \textit{semi-stable} lattices, as first introduced in \cite{MR780079}.
...
\end{definition}
\subsection{Some basis properties}
