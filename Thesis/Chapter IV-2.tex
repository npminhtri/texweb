...
\begin{prop}\label{cp-equiv}
    For  $x \in X_n = K\backslash G$,  it has canonical pair $(P,\delta)$ if and only if $P^{\delta}$ \red{fix this...} 
...
\begin{proof}
        ...
        \end{bmatrix}                                                                                                                                     \\
         & =\begin{bmatrix}
            ...
            \end{bmatrix}  A^{-1} \begin{bmatrix}
                                  ...
                                  \end{bmatrix}
    \end{align*}
    So the coefficient of $\alpha_{d_i-1}^\vee$ in $H_{\star B} (x\delta)$ corresponds to $p=d_{i-1}+1$ and $q=d_i$. Thus,
    ...
    \begin{align*}
        \begin{cases}
            \displaystyle  t_{d_i-1} = \log(a_1\cdots a_{d_i-1})-\sum_{u=1}^{n_i-1}\log\left(\dfrac{a_{d_{i-1}+u}}{a_{d_{i-1}+u+1}}\right)\dfrac{u}{ns_i}                  \\
