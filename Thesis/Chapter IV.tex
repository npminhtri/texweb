...
\begin{proof}
    ...
    where $k \in \SOn$, $n_P(x\delta) \in N_P$, $m_p(x\delta) \in M_P$ are as in section \ref{P-horospherical} and $a_P(x)$ is defined as in equation \eqref{A_P coor}. Then we compute
