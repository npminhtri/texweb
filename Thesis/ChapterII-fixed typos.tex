...
\end{align*}
A more thorough treatment of the Killing form can be found in \cite[Chapter 5]{MR499562} and \cite[Chapter 8]{MR499562}.
\subsection{Co-roots}
...
\end{example}
\subsection{Weights and coweights}
...
\end{theorem}
\begin{proof}
    We refer to \cite{MR2109105} for a proof of this fact.
\end{proof}
\begin{example}
