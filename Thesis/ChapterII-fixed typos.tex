...
\begin{remark}
    ...
    the root at both Lie algebra level and Lie group level.
\end{remark}
...
\begin{remark}
    It can be seen that $\omega_i$ can be thought of $\lambda_{i}\circ \log$, so we will also use $\lambda_i$ for the notation of simple weight in both Lie algebra and Lie group level as in the case of root. 
\end{remark}
\begin{example}
