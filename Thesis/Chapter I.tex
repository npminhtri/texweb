...
\hl{Moreover seems to be true - the domain $\mathfrak{D}$ is the place where the lattice $\left\langle 1,z\right\rangle$ forms a reduced basis.}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \fill[gray!20,semitransparent] (3,3) circle (1cm); % Radius is 1cm to match the shorter edge
  \end{tikzpicture}
